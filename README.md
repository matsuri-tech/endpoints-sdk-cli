...
_See code: [src/commands/add.ts](https://github.com/matsuri-tech/endpoints-sdk-cli/blob/v1.1.0/src/commands/add.ts)_
...
_See code: [src/commands/install.ts](https://github.com/matsuri-tech/endpoints-sdk-cli/blob/v1.1.0/src/commands/install.ts)_
...
_See code: [src/commands/update.ts](https://github.com/matsuri-tech/endpoints-sdk-cli/blob/v1.1.0/src/commands/update.ts)_
<!-- commandsstop -->
