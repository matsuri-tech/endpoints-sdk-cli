...
<!-- usage -->
```sh-session
$ yarn add endpoints-sdk-cli -D
$ mes COMMAND
running command...
$ mes (-v|--version|version)
endpoints-sdk-cli/2.0.4 darwin-x64 node-v13.2.0
$ mes --help [COMMAND]
USAGE
  $ mes COMMAND
...
...
_See code: [src/commands/add.ts](https://github.com/matsuri-tech/endpoints-sdk-cli/blob/v2.0.4/src/commands/add.ts)_
...
_See code: [src/commands/install.ts](https://github.com/matsuri-tech/endpoints-sdk-cli/blob/v2.0.4/src/commands/install.ts)_
...
_See code: [src/commands/update.ts](https://github.com/matsuri-tech/endpoints-sdk-cli/blob/v2.0.4/src/commands/update.ts)_
<!-- commandsstop -->
